...
const SUPERLIGA_FIREBASE_CONFIG={...(window.SUPERLIGA_FIREBASE_CONFIG||{})};
...
const SUPERLIGA_FIREBASE_RESULTS_FALLBACK=window.SUPERLIGA_FIREBASE_RESULTS_FALLBACK!==false;
...
const SUPERLIGA_ODDS_URL=window.SUPERLIGA_ODDS_URL||(SUPERLIGA_WORKER_URL?SUPERLIGA_WORKER_URL+'/odds':'');
const SUPERLIGA_TEAM_RATINGS_URL=window.SUPERLIGA_TEAM_RATINGS_URL||(SUPERLIGA_WORKER_URL?SUPERLIGA_WORKER_URL+'/team-ratings':'');
