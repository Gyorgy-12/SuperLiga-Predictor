...
function logo(n){let remote=window.__SUPERLIGA_LIGA2_LOGOS__&&window.__SUPERLIGA_LIGA2_LOGOS__[n];if(remote)return[remote];let id=TEAM_IDS[n];if(id)return['https://images.fotmob.com/image_resources/logo/teamlogo/'+id+'.png','https://images.fotmob.com/image_resources/logo/teamlogo/'+id+'_xsmall.png','https://images.fotmob.com/image_resources/logo/teamlogo/'+id+'.svg'];return[]}
